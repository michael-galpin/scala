...
@deprecated(DbcIsDeprecated, SinceVersion29) abstract class CharacterVarying extends Value {
...
/** An object offering transformation methods (views) on the value.
  ...
  * conversion. */
@deprecated(DbcIsDeprecated, SinceVersion29) object CharacterVarying {
