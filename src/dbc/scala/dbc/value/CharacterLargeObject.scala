...
@deprecated(DbcIsDeprecated, SinceVersion29) abstract class CharacterLargeObject extends Value {
...
/** An object offering transformation methods (views) on the value.
  ...
  * conversion. */
@deprecated(DbcIsDeprecated, SinceVersion29) object CharacterLargeObject {
