...
@deprecated(DbcIsDeprecated, SinceVersion29) abstract class ApproximateNumeric [Type] extends Value {
...
@deprecated(DbcIsDeprecated, SinceVersion29) object ApproximateNumeric {
