...
trait TraversableMethods[+A, +This <: TraversableLike[A, This]] extends TraversableOnceMethods[A] {
  ...
  // maps/iteration
  def flatMap[B, That](f: A => Flattenable[B])(implicit bf: CanBuildFrom[This, B, That]): That
  ...
  def ++[B >: A, That](that: Flattenable[B])(implicit bf: CanBuildFrom[This, B, That]): That
